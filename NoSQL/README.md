...
Potential issue if documents creation doesn’t work or this error: `Data directory /data/db not found., terminating` ([Stackoverflow article](https://stackoverflow.com/questions/37702957/mongodb-data-db-not-found))
...
The output of your script __must be exactly the same as the example__
